<h2><a href="https://www.geeksforgeeks.org/problems/even-odd-sum5450/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Even Odd Sum</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array Arr[] of N integers.Find the sum of values of even and odd index positions separately.</span></p>
